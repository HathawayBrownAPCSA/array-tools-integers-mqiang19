...
public class StringArrayTools
{
  ...
  public void fillKeyboard ()
  {
    ...
    System.out.println("Please enter strings on different lines, separated by 'return'");
    System.out.println("'return' twice to singal end of the list");
    
    arrayCount = 0;
    String n = keyboard.nextLine();
    while(n.length() != 0)                 // stop input when user returns twice
    {
      addItem(n);
      n = keyboard.nextLine();
    }
  ...
  /** Get largest word in a string array
    * @return the largest word of the array
    */
  ...
  /** Get the smallest word of the string array
    * @return the smallest string of the array
    */
  ...
  /** Get the index of the largest word of the string array
    * @return the index of the largest word of the array
    */
  ...
  /** Get the index of the smallest word of the stirng array
    * @return the index of the smallest string of the array
    */
